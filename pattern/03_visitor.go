...
/*
	Используется для добавления новых операций над объектом без добавления к нему новых методов.

	Плюсы:
		- Нет необходимости изменять структуру при добавлении нового функционала
		- Возможность разделения функционала и самой структуры
	Минусы:
		- Добавляет дополнительный уровень сложности к коду
		- Новый функционал не будет являться методом объекта, не сможет быть использован при работе с интерфейсами

	Примеры использования:
		- Добавление функции-надстройки над объектом, для которого строго задан конкретный ограниченный функционал
*/
