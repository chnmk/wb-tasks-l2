...
/*
	Используется для объединения схожего функционала в одну систему.

	Плюсы:
		- Повышает гибкость и масштабируемость кода, новый функционал добавляется без изменения исходных структур

	Минусы:
		- Добавляет дополнительный уровень сложности к коду
		- Во избежание неожиданного поведения необходимо следить за тем, какие структуры реализуют интерфейс стратегии

	Примеры использования:
		- При необходимости избавиться от множества условий типа if и switch
		- Когда одну и ту же операцию можно производить разными способами
